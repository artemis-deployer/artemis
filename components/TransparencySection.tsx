  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div>
              ...
              <p className="text-[#17131f]/70 text-base sm:text-lg leading-relaxed max-w-sm">
            ...
            <a
              href="#studio"
              className="mt-12 group text-left block rounded-lg overflow-hidden border border-[#17131f]/10 bg-white shadow-md hover:shadow-xl transition-all no-underline text-inherit"
            >
              ...
              <div className="p-5 bg-[#e4cef7] flex justify-between items-center text-sm font-semibold text-[#17131f]">
          ...
          <div className="lg:col-span-7 divide-y divide-[#17131f]/15">
            {disclosures.map((item, idx) => (
              <details
                ...
                open={idx === 0}
              >
                <summary className="text-lg md:text-xl font-light tracking-tight flex items-center justify-between gap-4 select-none list-none text-[#17131f] hover:text-[#7955ad] transition-colors">
                  <span>{item.title}</span>
                </summary>
                <p className="mt-3 text-sm text-[#17131f]/75 leading-relaxed pr-8">
                  {item.desc}
                </p>
              </details>
            ))}
        ...
        <div className="mt-28 pt-12 border-t border-[#17131f]/10">
          <p className="text-xs uppercase tracking-[0.2em] text-[#17131f]/50 mb-6 font-semibold font-mono">
            GO A LITTLE DEEPER
          </p>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              <a
                key={link.num}
                href={link.href}
                className="p-4 border border-[#17131f]/10 rounded bg-white/50 hover:bg-[#e4cef7] hover:border-[#e4cef7] transition-all flex justify-between items-center text-sm font-medium text-[#17131f] no-underline"
              >
