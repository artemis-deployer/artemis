  ...
  return (
    <div className={`arrival ${stage === 'ready' ? 'arrival-ready' : ''}`} aria-hidden="true">
      <div className="arrival-paper font-sans">
        <div className="arrival-masthead flex justify-between items-center text-[10px] tracking-[0.14em] text-[#80698f]">
          <span className="arrival-brand flex items-center gap-2.5 text-2xl font-bold tracking-tight text-[#24172e]">
        ...
        <div className="arrival-composition my-auto py-8">
          <p className="arrival-kicker text-[10px] tracking-[0.18em] text-[#80698f] mb-6 font-semibold">
            NON-CUSTODIAL LIQUIDITY DIRECTLY FROM YOUR WALLET
          </p>
          <div className="arrival-statement font-unbounded text-5xl md:text-8xl lg:text-9xl tracking-tight leading-none text-[#24172e] flex flex-col items-start font-bold">
            <span>Your next</span>
            <span className="arrival-redacted relative">
              coin is
              <span className="arrival-redaction">
                <i className="not-italic text-xs tracking-[0.28em] text-[#b4d5e5]">SOVEREIGN</i>
                <b className="text-3xl font-light text-[#b4d5e5]">↗</b>
              </span>
            </span>
            <span>yours.</span>
          </div>
          <div className="arrival-caption mt-6 flex gap-4 items-center text-[#80698f]">
            <span className="arrival-caption-rule w-8 h-[1px] bg-[#9c7eb0]"></span>
            <p className="text-xs">From spark to liquidity pool.<br />Completely self-custodied.</p>
          </div>
        </div>

        <div className="arrival-colophon flex justify-between gap-6 border-t border-[#b89dca55] pt-4 text-[10px] tracking-[0.14em] text-[#80698f]">
