...
export const WorksSection: React.FC<WorksSectionProps> = () => {
  ...
  return (
    <section
      id="how-it-works"
      data-theme="dark"
      className="works-section py-28 px-[max(6.25vw,24px)] w-full bg-[#131416] text-[#f8f6f0]"
    >
      ...
      <div ref={stackRef} className="work-stack space-y-6">
        {/* Card 1 */}
        <article className="work-card sticky top-24 rounded-lg bg-[#cadcf0] text-[#18191c] grid grid-cols-1 md:grid-cols-2 overflow-hidden shadow-2xl transition-transform duration-200">
          <div className="work-copy p-8 md:p-12 flex flex-col justify-between">
            <div>
              <div className="flex justify-between items-center text-xs font-mono uppercase tracking-widest text-[#18191c]/70 mb-6">
              ...
              <p className="text-sm md:text-base text-[#18191c]/80 leading-relaxed max-w-md">
            ...
            <div className="grid grid-cols-2 gap-6 pt-10 border-t border-[#18191c]/15 mt-8">
              <div className="border-l-2 border-[#18191c]/20 pl-4">
                <small className="block text-xs uppercase tracking-wider text-[#18191c]/60 mb-1">Total Supply</small>
                <strong className="block text-xl font-medium">999,000,000</strong>
                <small className="block text-xs uppercase tracking-wider text-[#18191c]/60 mt-3 mb-1">Mint Function</small>
                <strong className="block text-xl font-medium">None (Disabled)</strong>
              </div>
              <div className="border-l-2 border-[#18191c]/20 pl-4">
                <small className="block text-xs uppercase tracking-wider text-[#18191c]/60 mb-1">Ownership</small>
                <strong className="block text-xl font-medium">Non-Custodial</strong>
                <small className="block text-xs uppercase tracking-wider text-[#18191c]/60 mt-3 mb-1">Platform Cut</small>
        ...
        {/* Card 2 */}
        <article className="work-card sticky top-28 rounded-lg bg-[#fae8a4] text-[#18191c] grid grid-cols-1 md:grid-cols-2 overflow-hidden shadow-2xl transition-transform duration-200">
          <div className="work-copy p-8 md:p-12 flex flex-col justify-between">
            <div>
              <div className="flex justify-between items-center text-xs font-mono uppercase tracking-widest text-[#18191c]/70 mb-6">
            ...
            <div className="grid grid-cols-2 gap-6 pt-10 border-t border-[#18191c]/15 mt-8">
              <div className="border-l-2 border-[#18191c]/20 pl-4">
                <small className="block text-xs uppercase tracking-wider text-[#18191c]/60 mb-1">EVM Rail</small>
                <strong className="block text-xl font-medium">Uniswap V2</strong>
                <small className="block text-xs uppercase tracking-wider text-[#18191c]/60 mt-3 mb-1">Solana Rail</small>
                <strong className="block text-xl font-medium">pump.fun</strong>
              </div>
              <div className="border-l-2 border-[#18191c]/20 pl-4">
                <small className="block text-xs uppercase tracking-wider text-[#18191c]/60 mb-1">Rehearsal</small>
                <strong className="block text-xl font-medium">Free Testnets</strong>
                <small className="block text-xs uppercase tracking-wider text-[#18191c]/60 mt-3 mb-1">Router State</small>
        ...
        {/* Card 3 */}
        <article className="work-card sticky top-32 rounded-lg bg-[#ece4d4] text-[#18191c] grid grid-cols-1 md:grid-cols-2 overflow-hidden shadow-2xl transition-transform duration-200">
          <div className="work-copy p-8 md:p-12 flex flex-col justify-between">
            <div>
              <div className="flex justify-between items-center text-xs font-mono uppercase tracking-widest text-[#18191c]/70 mb-6">
            ...
            <div className="grid grid-cols-2 gap-6 pt-10 border-t border-[#18191c]/15 mt-8">
              <div className="border-l-2 border-[#18191c]/20 pl-4">
                <small className="block text-xs uppercase tracking-wider text-[#18191c]/60 mb-1">Private Keys</small>
                <strong className="block text-xl font-medium">Client Only</strong>
                <small className="block text-xs uppercase tracking-wider text-[#18191c]/60 mt-3 mb-1">Escrow</small>
                <strong className="block text-xl font-medium">None</strong>
              </div>
              <div className="border-l-2 border-[#18191c]/20 pl-4">
                <small className="block text-xs uppercase tracking-wider text-[#18191c]/60 mb-1">Local Receipts</small>
                <strong className="block text-xl font-medium">Indexed</strong>
                <small className="block text-xs uppercase tracking-wider text-[#18191c]/60 mt-3 mb-1">Block Explorer</small>
