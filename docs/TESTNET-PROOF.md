# Artemis Testnet Proof (Hood Testnet, chain 46630)

Deployed with the repo template (`contracts/ArtemisToken.sol` via `scripts/compile-token.mjs`) from a drill wallet. No mainnet funds involved.

- Token: `0x20ae6f49a369af85f6c4b9f5ed2f588eac5d9838`
- Name: Artemis Rehearsal / Symbol: KTST / Supply: 1000000000 * 1e18 (read back onchain)
